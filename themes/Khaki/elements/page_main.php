            ...
            <div class="container">
                <div class="nk-contacts-left">
                    <div class="nk-navbar">
                        <ul class="nk-nav">
                            ...
                            <li>
                                <a href="tel:+37001231078">
                                    <span class="nk-contact-icon"><i class="ion-ios-telephone"></i></span> + 3 (700) 123-1078</a>
                            </li>
                            <li>
                                <a href="mailto:info@khaki.com">
                                    <span class="nk-contact-icon"><i class="ion-ios-email"></i></span> info@khaki.com</a>
                            </li>
                        </ul>
                    </div>
                </div>
                <div class="nk-contacts-right">
                    <div class="nk-navbar">
                        <ul class="nk-nav">
                            <li>
                                <a href="https://twitter.com/nkdevv" target="_blank" class="nk-contact-icon">
                                    <span class="ion-social-twitter"></span>
                                </a>
                            </li>
                            <li>
                                <a href="https://dribbble.com/_nK" target="_blank" class="nk-contact-icon">
                                    <span class="ion-social-dribbble-outline"></span>
                                </a>
                            </li>
                            <li>
                                <a href="#" class="nk-contact-icon">
                                ...
                                <div class="nk-widget">
                                    <div class="nk-widget-store-cart">
                                        ...
                                        <div class="nk-widget-store-cart-total">
                                            <a href="#">
                                                <span class="ion-trash-b"></span> Empty Cart</a>
                                            <span>$1,700.00</span>
                                        </div>
                ...
                Sub Item
                    ...
                    <div class="nk-nav-row">
                        <div class="nk-nav-social">
                            ...
                            <footer>
                                <a href="http://nkdev.info" target="_blank">nK</a> &copy; 2017. All rights reserved
                            </footer>
                        </div>
                    </div>
                </div>
...
-->
        <div class="nk-header-title nk-header-title-md nk-header-title-parallax nk-header-title-parallax-opacity">
            <div class="bg-image op-5">
                <div style="background-image: url('assets/images/image-22.jpg');"></div>
            </div>
                ...
                <div class="nk-header-table-cell">
                    <div class="container">
                        ...
                        <div class="nk-header-text">
                            ...
                            <h1 class="nk-title display-4">
                                Khaki - Multipurpose Template
                            </h1>

                            <div class="nk-gap-2"></div>
                            <a href="#demos" class="nk-btn nk-btn-lg nk-btn-effect-1-bottom nk-btn-rounded nk-btn-circle-hover nk-btn-color-dark-2">
                                <span class="icon"><i class="ion-ios-gear"></i></span>
                                <span>Demos</span>
                            </a>
                            &nbsp;&nbsp;&nbsp;&nbsp;
                            <a href="https://themeforest.net/item/khaki-multiconcept-bootstrap-4-html-template/16826910?ref=_nK" target="_blank" class="nk-btn nk-btn-lg nk-btn-effect-1-bottom nk-btn-rounded nk-btn-circle-hover nk-btn-color-white text-dark-1">
                                <span class="icon">
                                    <span class="ion-bag"></span>
                                </span>
                                <span>Purchase</span>
            ...
            <div class="container">
                <div class="row md-gap vertical-gap">
                    ...
                    <div class="col-lg-4 col-md-6">
                        ...
                        <div class="sr-only">
                            <div class="nk-gap"></div>
                            <small>Hey, barbers should know that a good-looking appearance is a result. If you need a lovely site to show the process of your work, your workers&#39; presentations, your prices, the info where your customers can find you, and your customers&#39; reviews, you can check this demo. Surely, you can add other elements as well.</small>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-4 col-md-6">
                        ...
                        <div class="sr-only">
                            <div class="nk-gap"></div>
                            <small>Check this demo if you want to represent a product. It can be a quadrocopter or something else, of course. Media elements for a full demonstration are added. This page is perfect for selling.</small>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-4 col-md-6">
                        ...
                        <div class="sr-only">
                            <div class="nk-gap"></div>
                            <small>Are you a music label owner? Do you have some releases you want to promote? I guess, you can try to view this demo. All needed elements are available, there are promo blocks and pages for video clips, sliders and the list of latest releases, an events list and a blog for latest news. And don&#39;t forget about the Instagram feed! Keep your fans informed, they will be really happy.</small>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-4 col-md-6">
                        ...
                        <div class="sr-only">
                            <div class="nk-gap"></div>
                            <small>Don&#39;t let a band sink in the sea of chaotic information, give it a fine page with the info about future events and music - a nice audio player is available. Video and photo galleries are added too.</small>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-4 col-md-6">
                        ...
                        <div class="sr-only">
                            <div class="nk-gap"></div>
                            <small>This demo is good for promoting your games - it can be visually spectacular. Use it to promote your games or gaming communities.</small>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-4 col-md-6">
                        ...
                        <div class="sr-only">
                            <div class="nk-gap"></div>
                            <small>A site for an application shall be cool as this application is. Or even cooler if it can be compared... Anyway, with eCommerce features, a video demo, and nice mock-ups, your site will be cool enough.</small>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-4 col-md-6">
                        ...
                        <div class="sr-only">
                            <div class="nk-gap"></div>
                            <small>Whoa, you need a page for your mobile app? Check this demo, it has various elements to describe features, make a representation, show your stats and users&#39; testimonials. This page can be easily shared.</small>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-4 col-md-6">
                        ...
                        <div class="sr-only">
                            <div class="nk-gap"></div>
                            <small>You need to show some photos or illustrations? This demo is for you. A nice gallery with a lightbox with a zooming option. Of course, there are many other ways to show your images are supported in this template. Go to the Gallery menu item to view them all.</small>
                        </div>
                    </div>
        ...
        <div class="nk-box text-center">
            <div class="bg-image bg-image-parallax op-5" style="background-image: url('assets/images/image-28.jpg');"></div>
            <div class="nk-gap-5"></div>
            <h2 class="nk-title h1">Blog</h2>
            <div class="nk-gap"></div>
            <div class="container">
                <p>
                    Blogs are still actual because the text is universal. It is a great feature for anyone who wants to share their news and stories. These blogs can contain any media content you need: galleries, sliders, lists, stand-alone images, videos, and audio. So it will be good for bloggers or just someone who wants to share some information partially. It will be also good for small articles and long-reads.
                </p>
            </div>
            <div class="nk-gap"></div>
            <div class="row">
            ...
            <a href="blog-list.html" target="_blank" class="nk-btn nk-btn-lg nk-btn-rounded nk-btn-circle-hover nk-btn-color-dark-2">
                <span>See Live</span>
            </a>
            <div class="nk-gap-5"></div>
        </div>
        ...
        <!-- START: eCommerce -->
        <div class="nk-box bg-dark-2 text-white text-center">
            <div class="bg-image bg-image-parallax op-2" style="background-image: url('assets/images/image-12.jpg');"></div>
            <div class="nk-gap-5"></div>
            <h2 class="nk-title h1">eCommerce</h2>
            <div class="nk-gap"></div>
            <div class="container">
                <p class="op-8">
                    It isn't revolutionary to buy something online, it is so natural today, we don't even notice it. The Khaki template has eCommerce features that are needed for everyone who wants to sell something online. There is a cart, a page with billing details, products lists, of course, and single pages with products reviews. So you can use them for a store site, and simply add additions to your site to sell some merchandise, for example.
                </p>
            </div>
            <div class="nk-gap"></div>
            <div class="row">
            ...
            <div class="nk-gap-3"></div>
            <a href="store.html" target="_blank" class="nk-btn nk-btn-lg nk-btn-rounded nk-btn-circle-hover nk-btn-color-white text-dark-1">
                <span>See Live</span>
            </a>
            <div class="nk-gap-5"></div>
        </div>
        ...
        <!-- START: Portfolio -->
        <div class="nk-box text-center bg-gray-2">
            <div class="nk-gap-5"></div>
            <h2 class="nk-title h1">Portfolio</h2>
            <div class="nk-gap"></div>
            <div class="container">
                <p class="op-8">
                    Many elements are available in the Khaki template to present projects. You can show your texts, photos, some inventions, apps, adventures with well-designed means. It is possible to tell a whole story of creation, choose any layout for your content to make this story complete. You can get some feedback, add some options for sharing your pages.
                </p>
            </div>
            <div class="nk-gap"></div>
            <div class="row">
            ...
            <div class="nk-gap-3"></div>
            <a href="portfolio-1-gap.html" target="_blank" class="nk-btn nk-btn-lg nk-btn-rounded nk-btn-circle-hover nk-btn-color-dark-2">
                <span>See Live</span>
            </a>
            <div class="nk-gap-5"></div>
        </div>
        ...
        <div class="nk-box">
            ...
            <div class="container">
                <h2 class="nk-title h1 text-center">Why Choose Khaki</h2>
                <div class="nk-gap"></div>
                <p class="op-6 text-center">
                ...
                <div class="row align-items-center">
                    <div class="col-md-4">
                        <div class="nk-ibox-1 nk-ibox-inverted nk-ibox-hover">
                            <div class="nk-ibox-icon nk-ibox-icon-circle nk-ibox-icon-hover-bg-color-dark-2">
                                <span class="ion-grid"></span>
                            </div>
                            <div class="nk-ibox-cont">
                                <h3 class="nk-ibox-title"><a href="#">Swipe Side Navigations</a></h3>
                        ...
                        <div class="nk-ibox-1 nk-ibox-inverted nk-ibox-hover">
                            ...
                            <div class="nk-ibox-cont">
                                <h3 class="nk-ibox-title"><a href="#">Unlimited Layouts</a></h3>
                        ...
                        <div class="nk-ibox-1 nk-ibox-inverted nk-ibox-hover">
                            ...
                            <div class="nk-ibox-cont">
                                <h3 class="nk-ibox-title"><a href="#">Mega Menu</a></h3>
                    ...
                    <div class="col-md-4">
                        <div class="nk-ibox-1 nk-ibox-hover">
                            ...
                            <div class="nk-ibox-cont">
                                <h3 class="nk-ibox-title"><a href="#">Smooth Animations</a></h3>
                        ...
                        <div class="nk-ibox-1 nk-ibox-hover">
                            ...
                            <div class="nk-ibox-cont">
                                <h3 class="nk-ibox-title"><a href="#">Tons of predefined elements</a></h3>
                        ...
                        <div class="nk-ibox-1 nk-ibox-hover">
                            ...
                            <div class="nk-ibox-cont">
                                <h3 class="nk-ibox-title"><a href="#">Bootstrap 4</a></h3>
            ...
            <div class="container">
                <div class="row vertical-gap align-items-center">
                    ...
                    <div class="col-md-7 pull-md-5">
                        <h2 class="nk-title h1">Parallaxed Backgrounds</h2>
                        <div class="nk-gap"></div>
                        <p class="lead">Background images can be shown with a parallax, and the position of an image can be changed not only by just scrolling up and down but also with the cursor position and by the way you hold your device. So you can avoid the feeling of a static page and make it alive.</p>
                    </div>
                </div>
                <div class="nk-gap-1"></div>
                <div class="row vertical-gap align-items-center">
                    ...
                    <div class="col-md-7">
                        <h2 class="nk-title h1">Swipe Side Navigations</h2>
                        <div class="nk-gap"></div>
                        <p class="lead">Side menus became popular when developers started using it in their mobile apps where there is no much space on the screen. It is natural for any device right now, and can be also intuitive. And it will look amazing for a desktop version of your site too.</p>
                    </div>
                </div>
                <div class="nk-gap-1"></div>
                <div class="row vertical-gap align-items-center">
                    ...
                    <div class="col-md-7 pull-md-5">
                        <h2 class="nk-title h1">Smooth Animations</h2>
                        <div class="nk-gap"></div>
                        <p class="lead">You can see that animations look really smooth. It is provided by the Khaki core, and it is also included in this template. Slidings, counters, buttons animations, a parallax, appearing and disappearing - these features are some kind of a language your site can talk.</p>
                    </div>
                </div>
            </div>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-8 offset-md-2 col-lg-6 offset-lg-3">
                        <h2 class="nk-title text-center h1">Want WordPress Theme?</h2>
                        <div class="nk-gap-1"></div>
